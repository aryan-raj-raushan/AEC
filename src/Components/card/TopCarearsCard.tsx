...
export default function TopCarearsCard({
  CarearsData,
  id,
  onApplyNow,
  AppliedCareear,
  ...
  const isApplied = AppliedCareear?.some(
    (applied: any) => applied.careers.data.id === careearId
  );
      ...
      <div className="flex flex-col border items-stretch w-full bg-white rounded-lg shadow-lg">
        ...
        <div className="relative flex flex-col">
          ...
          <div className="p-2 flex-1 flex flex-col gap-2">
            <div>
              <Link
                href={`/careers/${id}/info`}
                className="text-primary text-lg font-semibold line-clamp-1"
              >
