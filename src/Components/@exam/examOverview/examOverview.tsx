		...
		<section className="mainSection px-4">
			...
			<div className="flex gap-4 max-w-screen-xl mx-auto mb-4">
				<div className="flex-1 flex flex-col gap-4">
					<Accordian title="JEE Advanced 2024" titlePrimary opened>
						<div className="flex flex-col gap-5">
							<div>
								{`The JEE Advanced 2024 exam is scheduled to take place on May 26, 2024. The application process for JEE Advanced 2024 will commence on April 21, 2024, and candidates have until April 30, 2024, to complete the application. The deadline for JEE Advanced application fee payment is May 6, 2024. Prior to applying, it is recommended that candidates thoroughly review the JEE Advanced eligibility criteria for 2024. Successful registrants for the JEE Advanced exam will have access to the admit card from May 17 to May 26, 2024. To be eligible for the JEE Advanced 2024 exam, candidates must have qualified in JEE Main 2024 and obtained a rank within the top 2.5 lakh candidates. Detailed information on various aspects of the JEE Advanced 2024 exam can be found in the sections below.`}
							</div>
							<Separator />
