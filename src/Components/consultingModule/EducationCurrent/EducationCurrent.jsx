...
const EducationCurrent = ({ onClose }) => {
      ...
      {modalOpen === "basic" && (
        <div className="fixed inset-0 flex items-center justify-center !z-[999] bg-gray-500 bg-opacity-30 ">
          <div className="flex items-center justify-center w-full lg:w-[900px] mt-20 h-[550px]">
            {/* Left Panel */}
            <div className="relative w-2/5 h-[610px] bg-white hidden md:block">
                  ...
                  <div className="md:flex gap-4 mt-4">
                    <div className="">
                      <input
                        ...
                        className="outline-none border border-white text-white bg-transparent w-full p-2 rounded-md"
                      />
                    </div>
                    <div className="md:flex gap-4 mt-4">
                      <input
