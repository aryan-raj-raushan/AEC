...
import CollegeFilters from "../collegeFilters/collageFilters";

export default function DiscussionFrom({ title, description }: any) {
  const dummyData = [
    {
      id: 1,
      icon: "T",
    ...
    <>
      <section className="PageInfo">
        <PageInfo
          ...
          pageType="discussionForum"
        />
      </section>
      <div className="fixed bottom-0 left-0 z-10 w-full lg:hidden block">
        <div className="flex justify-evenly items-center text-white bg-primary text-[28px]">
      ...
      <section className="mainSection flex md:flex-row flex-col gap-4">
        <div className="hidden lg:block max-w-64">
          {/* <Filter
            name={"COLLEGES"}
            filters={[]}
        ...
        <div className=" flex flex-col gap-4">
          <div className="px-5 py-6 border-[0.5px] border-primary-text-light max-w-80 rounded-md">
            <div className="flex justify-between items-center">
              <h1 className="font-semibold text-[#16]"># Trending Hastags</h1>
              <span className="text-xs text-blue-400 font-semibold cursor-pointer">
                See more
              </span>
            </div>
            <hr className="mt-2" />
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-between gap-1">
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-[9px] font-bold text-primary">Worst</div>
                </div>
                <div className="flex flex-col items-center">
                  <div>
                ...
                <div className="flex flex-col items-center">
                  <div>
                    <Image src={NeutralEmoji} width={30} height={30} alt="" />
                  </div>
          ...
          <div className="px-5 py-6 border-[0.5px] border-primary-text-light max-w-80 flex flex-col gap-5 rounded-md">
            <div className="flex flex-col gap-5">
