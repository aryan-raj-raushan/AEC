...
import UpdateDateArticle from "@/src/Components/updatedDateArticle/updatedDateArticle";
		...
		<section className="mainSection px-4">
			...
			<div className="flex gap-4 max-w-screen-xl mx-auto mb-4">
				<div className="flex-1 flex flex-col gap-4">
					<Accordian
						title="BTech Syllabus and Subjects Overview"
						titlePrimary
						opened
					>
						<div className="flex flex-col gap-5">
							<div>
								{`The BTech curriculum includes fundamental, elective, and laboratory subjects, with variations in elective subjects across different universities. Tailored for individuals aspiring to enter the corporate and core tech sectors, the BTech subjects are designed to be accessible. The four-year course is divided into eight semesters, with subjects like Physics, Mathematics, Chemistry, Mechanics, English, Electrical Technology, Engineering Drawing and Graphics, Programming, and Data Structures being common throughout the curriculum. Key Points about BTech Syllabus and Subjects: If you're interested in pursuing a technology degree, BTech provides diverse specializations such as Information Technology, Digital Electronics, Structural Analysis, and more. To enroll in BTech, completion of Class 12 and participation in entrance exams like JEE Mains or JEE Advanced is required. The BTech syllabus and subjects encompass nearly 100 specializations, including civil, mechanical, electrical, computer science, nuclear, biomedical, biotechnology, and others, each concentrating on different domains. Students can choose subjects aligned with their interests within the broad spectrum of specializations offered. The B Tech course spans four years, delving into the realms of engineering and technology. For further insights into BTech subjects, refer to the details below.`}
							</div>
							<Separator />

							<div className="flex flex-col gap-4">
								<h6 className="text-primary text-[25px] font-semibold ">
									JEE Advanced Highlights 2024
								</h6>
								<div>
									Candidates can check key aspects related to the JEE Advanced
									Exam 2024 as mentioned in the table below
								</div>
                    ...
                    <CarouselComponent
                      ...
                      slides={[1, 2, 3, 4, 5, 6, 7, 8].map((item) => {
                        return <CoursePrimaryCard key={item} />;
                      })}
                    />
                  </div> */}
								</div>
