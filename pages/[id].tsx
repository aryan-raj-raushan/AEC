...
const LandingPageDetails = () => {
  ...
  const { singleLandingPageData, loading, error } =
    GetSingleLandingPageById(landingPageId);
              ...
              <div className="flex flex-col flex-1 gap-3">
                <div className="flex gap-4 items-center">
                  <h1 className="font-bold text-3xl">
                    {LandingPageData?.landing_page} :{" "}
                    {LandingPageData?.landing_page_title}
                  </h1>
                </div>
                <div className="flex gap-4 justify-end  absolute bottom-0 right-0 mt-[2.5rem]">
